...
class LightingScene extends CGFscene
{
	...
	init(application)
	{
		...
		this.paperPlane = new MyPaperPlane(this, 12, 4.3, 4.5);
		this.lamp = new MyLamp(this,8,20);
		this.pillar = new MyCilinder(this,8,20);

		this.clock = new MyClock(this, 12);

		this.boardA = new Plane(this,-0.25, 1.25, 0.1, 0.8, BOARD_A_DIVISIONS);
    	...
    	this.materialWall.setDiffuse(0.4,1,0.8,1);
	...
	display()
	{
		...
		//Paper Plane
		this.pushMatrix();
			this.translate(this.paperPlane.x + 0.5, this.paperPlane.y, this.paperPlane.z + 3);
			this.rotate(this.paperPlane.rotZ * Math.PI / 180.0, 0, 0, 1);
			this.rotate(this.paperPlane.rotX * Math.PI / 180.0, 1, 0, 0);	
	...
	update(currTime) {
		...
		this.paperPlane.update(this.currTime);
	};
};