...
{ 
	constructor(scene) 
	{
		...
		this.tableAppearence.setAmbient(0.5, 0.5, 0.5, 1);
		this.tableAppearence.setDiffuse(10, 10, 10, 1);
		this.tableAppearence.setSpecular(0.5, 0.5, 0.5, 1);
		this.tableAppearence.setShininess(2);
